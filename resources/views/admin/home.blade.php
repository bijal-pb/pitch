            ...
            <div class="p-3 bg-success-300 rounded overflow-hidden position-relative text-white mb-g">
                <div class="">
                    <h3 class="display-4 d-block l-h-n m-0 fw-500">
                        {{ $data->total_business_user }}
                        <small class="m-0 l-h-n">Business Users</small>
                    </h3>
                </div>
                <i class="fal fa-user-tie position-absolute pos-right pos-bottom opacity-15 mb-n1 mr-n1" style="font-size:6rem"></i>
            </div>
        </a>
    </div>
    <div class="col-sm-6 col-xl-3">
        <a href="{{ route('admin.user') }}" >
            <div class="p-3 bg-warning-400 rounded overflow-hidden position-relative text-white mb-g">
                <div class="">
                    <h3 class="display-4 d-block l-h-n m-0 fw-500">
                        {{ $data->total_pladge_user }} 
                        <small class="m-0 l-h-n">Pledge Users</small>
                    </h3>
                </div>
    ...
    <div class="col-sm-6 col-xl-3">
        <div class="p-3 bg-danger-200 rounded overflow-hidden position-relative text-white mb-g">
            <div class="">
                <h3 class="display-4 d-block l-h-n m-0 fw-500">
                    ${{ $data->total_pledged }} 
                    <small class="m-0 l-h-n">Pledged Amount</small>
                </h3>
            </div>
            <i class="fal fa-play-circle position-absolute pos-right pos-bottom opacity-15 mb-n1 mr-n4" style="font-size: 6rem;"></i>
        </div>
    </div>
    <div class="col-sm-6 col-xl-3">
        <a href="{{ route('admin.refund') }}" >
            <div class="p-3 bg-info-200 rounded overflow-hidden position-relative text-white mb-g">
                <div class="">
                    <h3 class="display-4 d-block l-h-n m-0 fw-500">
                        ${{ $data->total_refund }} 
                        <small class="m-0 l-h-n">Refund</small>
                    </h3>
                </div>
