...
<div class="subheader">
    <h1 class="subheader-title">
        <i class='subheader-icon fal fa-registered'></i>Refund<span class='fw-300'></span> <sup class='badge badge-primary fw-500'></sup>
        {{-- <small>
...
<div class="row">
    <div class="col-xl-12">
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
                <h2>
                   Refund<span class="fw-300"><i></i></span>
                </h2>
            ...
            <div class="panel-container show">
                ...
                <div class="panel-content" >
                    <div id="categoryData">
                        <table id="refund-table" class="table table-bordered table-hover table-striped w-100 dataTable dtr-inline">
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        var table =  $('#refund-table').DataTable(
                {
                    ...
                    columns: [
                        ...
                        {data: 'refund_date', name: 'update_at'},
        ...
        $("#save").click(function (e) {
            ...
            var ajaxurl = "{{ route('admin.refund.store') }}";
            $.ajax({
                type: "POST",
                url: ajaxurl,
                data: formData,
