...
<footer class="page-footer" role="contentinfo">
    <div class="d-flex align-items-center flex-1 text-muted">
        <span class="hidden-md-down fw-700">{{ now()->year }} © Pitch</span>
    </div>
    {{-- <div>
...
<script src="{{ URL::asset('admin_assets/js/datagrid/datatables/datatables.bundle.js')}}"></script>
<script src="{{ URL::asset('admin_assets/js/dependency/moment/moment.js')}}"></script>
<script src="{{ URL::asset('admin_assets/js/formplugins/bootstrap-daterangepicker/bootstrap-daterangepicker.js')}}"></script>
